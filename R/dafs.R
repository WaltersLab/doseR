#' @title dafs
#' @description This function filters the expression using DAFS (see ref). This is a core function invoked by the DAFS wrapper.
#' @param VEC1 Vector 1, not intended for user interaction.
#' @param PLOT Boolean, toggles plotting.
#' @details This function filters the expression, using Data Adaptive Flag method.
